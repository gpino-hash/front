                    ...
                    <div className="bg-white dark:bg-slate-900 border border-slate-300/70 dark:border-slate-800 rounded-xl p-8 shadow-[0_8px_40px_rgba(0,0,0,0.12),0_1px_3px_rgba(0,0,0,0.06)] dark:shadow-2xl">
                        ...
                        <div className="mt-6 grid grid-cols-2 gap-4">
                            <button
                                ...
                                className="flex w-full items-center justify-center gap-2 rounded-lg bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 px-4 py-2.5 text-sm font-semibold text-slate-700 dark:text-white hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                {isGoogleLoading ? (
                            ...
                            <button
                                type="button"
                                disabled
                                className="flex w-full items-center justify-center gap-2 rounded-lg bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 px-4 py-2.5 text-sm font-semibold text-slate-700 dark:text-white transition-colors opacity-50 cursor-not-allowed"
                                title="Próximamente"
                            >
